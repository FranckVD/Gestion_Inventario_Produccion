...
---
Sistema personal de gestión optimizada de recursos y producción desarrollado por `FranckVD`, para visualizar la app vé a [gestiónInventario](https://gestioninventarioapp.streamlit.app/).
